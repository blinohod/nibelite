...
PG="/usr/bin/psql"
SQL_SCRIPT="/opt/nibelite/share/sql/tvchat/tvchat.sql"
...
$NS srv-add ctl-tvchat --uri="tvchat.php" --descr="SMS TV Chat GUI" --visible=1
$NS action-add ctl-tvchat.access

$NA group-add tvchat

$NS action-group-add ctl-tvchat.access admin
$NS action-group-add ctl-tvchat.access tvchat
